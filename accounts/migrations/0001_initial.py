    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('startup', 'Startup'), ('commercial', 'Commercial')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_mobile_number', models.CharField(blank=True, max_length=50)),
                ('aadhar_number', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dp_certificate_no', models.CharField(blank=True, max_length=255)),
                ('udyam_certificate', models.BooleanField(default=False)),
                ('udyam_certificate_no', models.CharField(blank=True, max_length=255)),
                ('company_type', models.CharField(blank=True, max_length=255)),
                ('owner_aadhar_card', models.CharField(blank=True, max_length=255)),
                ('gst_number', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_of_semester', models.CharField(blank=True, max_length=100)),
                ('aadhar_number', models.CharField(blank=True, max_length=50)),
                ('address', models.TextField(blank=True)),
                ('mobile_number', models.CharField(blank=True, max_length=50)),
                ('enrollment_no', models.CharField(blank=True, max_length=100)),
                ('collage_idcard', models.CharField(blank=True, max_length=255)),
